...
const PostDetail = ({ post }) => {
  ...
  return (
    <div className="bg-emerald-100 shadow-lg rounded-lg lg:p-8 pb-12 mb-8">
      ...
      <div className="px-4 lg:px-0">
        ...
        <h1 className="mb-8 text-3xl font-semibold text-slate-900 dark:text-white">
          {post.title}
        </h1>
        <div className="text-justify text-black text-lg">
